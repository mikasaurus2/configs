...
let s:light_green = { "gui": "#98C379", "cterm": "83", "cterm16": "2" }
let s:green = { "gui": "#98C379", "cterm": "114", "cterm16": "2" }

let s:yellow = { "gui": "#E5C07B", "cterm": "180", "cterm16": "3" }
let s:dark_yellow = { "gui": "#D19A66", "cterm": "172", "cterm16": "11" }
let s:tan = { "gui": "#E5C07B", "cterm": "216", "cterm16": "3" }
...
let s:light_purple = { "gui": "#C678DD", "cterm": "183", "cterm16": "5" }

let s:cyan = { "gui": "#56B6C2", "cterm": "38", "cterm16": "6" } " Alternate cterm: 73

let s:white = { "gui": "#ABB2BF", "cterm": "254", "cterm16" : "7" }

let s:black = { "gui": "#282C34", "cterm": "233", "cterm16": "0" }
let s:background_black = { "gui": "#282C34", "cterm": "235", "cterm16": "0" }
...
let s:comment_red = { "gui": "#5C6370", "cterm": "203", "cterm16": "15" }
let s:gutter_fg_grey = { "gui": "#636D83", "cterm": "246", "cterm16": "15" }
...
call s:h("Comment", { "fg": s:comment_red, "gui": "italic", "cterm": "italic" }) " any comment
...
call s:h("PreProc", { "fg": s:tan }) " generic Preprocessor
call s:h("Include", { "fg": s:blue }) " preprocessor #include
call s:h("Define", { "fg": s:purple }) " preprocessor #define
call s:h("Macro", { "fg": s:purple }) " same as Define
call s:h("PreCondit", { "fg": s:tan }) " preprocessor #if, #else, #endif, etc.
call s:h("Type", { "fg": s:tan }) " int, long, char, etc.
call s:h("StorageClass", { "fg": s:tan }) " static, register, volatile, etc.
call s:h("Structure", { "fg": s:tan }) " struct, union, enum, etc.
call s:h("Typedef", { "fg": s:tan }) " A typedef
...
call s:h("Folded", { "fg": s:comment_red }) " line used for closed folds
call s:h("FoldColumn", {}) " 'foldcolumn'
call s:h("SignColumn", {}) " column where signs are displayed
call s:h("IncSearch", { "fg": s:black, "bg": s:light_purple }) " 'incsearch' highlighting; also used for the text replaced with ":s///c"
call s:h("LineNr", { "fg": s:gutter_fg_grey }) " Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
call s:h("CursorLineNr", {}) " Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
call s:h("MatchParen", { "fg": s:light_green, "cterm": "bold", "gui": "underline" }) " The character under the cursor or just before it, if it is a paired bracket, and its match.
call s:h("ModeMsg", {}) " 'showmode' message (e.g., "-- INSERT --")
call s:h("MoreMsg", {}) " more-prompt
call s:h("NonText", { "fg": s:special_grey }) " '~' and '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line).
call s:h("Normal", { "fg": s:white, "bg": s:background_black }) " normal text
call s:h("Pmenu", { "bg": s:menu_grey }) " Popup menu: normal item.
call s:h("PmenuSel", { "fg": s:blue, "bg": s:black }) " Popup menu: selected item.
call s:h("PmenuSbar", { "bg": s:special_grey }) " Popup menu: scrollbar.
call s:h("PmenuThumb", { "bg": s:white }) " Popup menu: Thumb of the scrollbar.
call s:h("Question", { "fg": s:purple }) " hit-enter prompt and yes/no questions
call s:h("Search", { "fg": s:black, "bg": s:light_purple, "cterm": "bold" }) " Last search pattern highlighting (see 'hlsearch'). Also used for highlighting the current line in the quickfix window and similar items that need to stand out.
